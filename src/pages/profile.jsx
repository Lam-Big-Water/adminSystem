        ...
        <form className="w-full flex flex-col gap-4" onSubmit={handleSubmit}>
          ...
          <div className="flex flex-col gap-2">
            ...
            <textarea
              ...
              value={formData.bio}
              onChange={handleInputChange}
              className="min-h-30 w-full min-w-0 placeholder:text-zinc-400 rounded-md border border-border px-3 py-1 text-base shadow-xs transition-[color,box-shadow]"
            />
            <p className="text-sm text-muted-foreground">
          ...
          <div className="flex flex-col gap-2">
            ...
            {formData.urls.map((url, index) => (
              <input
                ...
                value={url}
                onChange={handleInputChange}
                className="h-9 w-full min-w-0 placeholder:text-zinc-400 rounded-md border border-border px-3 py-1 text-base shadow-xs transition-[color,box-shadow] mb-2"
                type="text"
              />
            ))}
          </div>
